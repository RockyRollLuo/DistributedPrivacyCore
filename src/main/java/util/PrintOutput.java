...
//
//    public static void printGraphStatistic(Graph graph) {
//        long startTime = System.nanoTime();
//
//        ArrayList<Integer> nodeList = graph.getNodeList();
//        HashMap<Integer, ArrayList<Integer>> edgeMap = graph.getEdgeMap();
//
//        int m = edgeMap.size();
...
//    }
//
//    public static void printCumulativeCardinalityDistribution(Graph graph) {
//        HashMap<Integer, ArrayList<Integer>> edgeMap = graph.getEdgeMap();
...
//    }
//
//    public static void printDegreeDistribution(Graph graph) {
//        long startTime = System.nanoTime();
//
//        HashMap<Integer, Integer> degreeMap = graph.getDegreeMap();
...
//    }
//
//    public static void printNeighborNumsDistribution(Graph graph) {
//        long startTime = System.nanoTime();
//
//        HashMap<Integer, Integer> neighborNumMap = graph.getNeighborNumMap();
...
//    }
//
//    public static void printDegreeCoreDistribution(Graph graph) {
//        long startTime = System.nanoTime();
//
//        DecompositionDegree decompositionDegree = new DecompositionDegree(graph);
...
//
//
//    public static void printNeighborCoreDistribution(Graph graph) {
//        long startTime = System.nanoTime();
//
//        DecompositionNeighbor decompositionNeighbor = new DecompositionNeighbor(graph);
