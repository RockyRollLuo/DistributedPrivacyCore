...
public class DistributeCoreDecomposition {
    private static Logger LOGGER = Logger.getLogger(DistributeCoreDecomposition.class);

    private final Graph graph;

    public DistributeCoreDecomposition(Graph graph) {
        this.graph = graph;
    }
